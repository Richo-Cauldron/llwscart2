<div>
    <nav class="flex flex-wrap items-center justify-between p-6 mb-6 shadow">
        ...
        <div class="flex-grow block w-full md:flex md:items-center md:w-auto">
            <div class="text-sm md:flex-grow">
                <a href="/" data-turbolinks-action="replace" class="block mt-4 mr-4 md:inline-block md:mt-0">
                    Home
                </a>
                <a href="/products" data-turbolinks-action="replace" class="block mt-4 mr-4 md:inline-block md:mt-0">
                    Products
                </a>
                <a href="/cart" data-turbolinks-action="replace" class="block mt-4 mr-4 md:inline-block md:mt-0">
                    Cart({{ $cartTotal }})
                </a>
            </div>
        </div>
